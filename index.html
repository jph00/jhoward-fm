...
{% include image-r url="jeremy.jpg" w="250" %}

I am a [founding researcher](https://fast.ai/about) at fast.ai, and an [honorary professor](https://researchers.uq.edu.au/researcher/33290) at the University of Queensland. If and when I find some time, I'll flesh this personal web site out a little more. In the meantime, here's a quick list of a few of the **things I've created** (or co-created):

## Deep Learning and Machine Learning

- [Answer.AI](https://www.answer.ai/) (with [Eric Ries](https://en.wikipedia.org/wiki/Eric_Ries)), a new kind of AI R&D lab which creates practical end-user products based on foundational research breakthroughs.
- The [ULMFiT algorithm](https://towardsdatascience.com/understanding-ulmfit-and-elmo-the-shift-towards-transfer-learning-in-nlp-b5d8e2e3f664) for training large language models (LLMs), on which all modern LLMs (including ChatGPT, Bard, etc) are based, and which helped to [crack the code of natural language](https://www.nytimes.com/2018/11/18/technology/artificial-intelligence-language.html).
- [course.fast.ai](https://course.fast.ai), which is the longest-running and (AFAIK) most widely-used deep learning course in the world, and has launched many careers in research, industry, and startups. The Economist featured the course in their article "*[New schemes teach the masses to build AI](https://www.economist.com/business/2018/10/27/new-schemes-teach-the-masses-to-build-ai) --
Treating it like a craft is paying dividends*". I am an honorary [professor at the University of Queensland](https://www.eait.uq.edu.au/article/2022/03/renowned-ai-expert-joins-uq-help-develop-local-talent) and have taught parts of the course from there.
...
Find me on: <a rel="me" href="https://sigmoid.social/@jh">Mastodon</a>.
